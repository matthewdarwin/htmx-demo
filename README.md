...
Account management: login (password or a one-time e-mail link), account
recovery/registration, logout, and — once logged in — an account overview
page linking to a membership status/creation hub, change name,
...
"Authentication" and "Content sourcing" sections for the return-to-origin
mechanism, JWT cookie handling, and the fetched-fields pattern behind
these.
